...
prompts_path = base_dir / "prompts" / "prompts_topico_1_a_4.json"
outputs_dir = base_dir / "outputs" / "Qwen3" # Mistral 
                                             # Llama 3.1
                                             # GPT-OSS
outputs_dir.mkdir(exist_ok=True)

json_output_path = outputs_dir / "respostas_qwen3_0.25.json" # respostas_qwen3_0.75.json 
                                                             # respostas_mistral_0.75.json 
                                                             # respostas_mistral_0.25.json 
                                                             # respostas_llama_0.75.json 
                                                             # respostas_llama_0.25.json 
                                                             # respostas_gpt_oss_0.75.json 
                                                             # respostas_gpt_oss_0.25.json 
